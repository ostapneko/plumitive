...
case object Schema {
  class Documents(tag: Tag) extends Table[Document](tag, "documents") {
    ...
    def fromRow(id: String, title: String, scannedText: Option[String], sender: String, recipientsStr: String, year: Int, monthNum: Option[Int], tagsStr: String): Document = {
    ...
    def toRow(d: Document): Option[(String, String, Option[String], String, String, Int, Option[Int], String)] =
      Some((
        d.id.unId,
        d.title.unTitle,
        d.scannedText,
    ...
    def scannedText = column[Option[String]]("scanned_text")
    ...
    def * = (id, title, scannedText, sender, recipients, year, month, tags) <> ((fromRow _).tupled, toRow _)
  }
